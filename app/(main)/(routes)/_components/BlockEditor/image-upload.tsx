...
interface ImageUploadProps {
    ...
    forCover?: boolean; // Nuevo prop para indicar si es para la portada
}
...
export default function ImageUpload({
    ...
    const validateFile = (file: File): boolean => {
        if (file.size > MAX_FILE_SIZE) {
            ...
            onImageError(`El archivo excede el límite de ${maxSize}MB`);
            return false;
        }
                ...
                {activeTab === 'upload' ? (
                    ...
                    >
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                            {forCover
                                ? "Imagen recomendada: 1500 x 500 píxeles"
